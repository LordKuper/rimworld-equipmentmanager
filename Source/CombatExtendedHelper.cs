...
internal static class CombatExtendedHelper
{
    ...
    public static void Initialize()
    {
        ...
        _enableAmmoSystemMethod = AccessTools.MethodDelegate<EnableAmmoSystemDelegate>(
            AccessTools.PropertyGetter(AccessTools.TypeByName("CombatExtended.Settings"),
                "EnableAmmoSystem"),
            AccessTools.Field(AccessTools.TypeByName("CombatExtended.Controller"), "settings")
                .GetValue(null));
        CompAmmoUserType = AccessTools.TypeByName("CombatExtended.CompAmmoUser");
        AmmoSetDelegate =
            AccessTools.FieldRefAccess<Def>(
                AccessTools.TypeByName("CombatExtended.CompProperties_AmmoUser"), "ammoSet");
        AmmoTypesDelegate =
            AccessTools.FieldRefAccess<object>(AccessTools.TypeByName("CombatExtended.AmmoSetDef"),
                "ammoTypes");
        AmmoDelegate =
            AccessTools.FieldRefAccess<ThingDef>(AccessTools.TypeByName("CombatExtended.AmmoLink"),
                "ammo");
    }
