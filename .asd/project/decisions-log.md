...
## 2026-06-07 — Sprint 001-full-audit-alignment completed, archived

- **Decision**: sprint 001-full-audit-alignment completed, archived; PR: https://github.com/LordKuper/rimworld-equipmentmanager/pull/7
- **Rationale**: User CONFIRMED PR opening after in-game manual verification passed. PR #7 opened against `main`; sprint folder moved to `.asd/sprints/archived/001-full-audit-alignment/`; `state.json` finalized (phase=done, archived_at=2026-06-07, pr_url set).
- **Affected docs**: `.asd/sprints/archived/001-full-audit-alignment/state.json`, `.asd/project/decisions-log.md`.
